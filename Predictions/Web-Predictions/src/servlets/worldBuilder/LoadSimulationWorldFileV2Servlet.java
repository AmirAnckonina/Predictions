...
@WebServlet(name = "LoadSimulationWorldFileV2Servlet", urlPatterns = "/worldBuilder/loadSimulationWorldFileV2")
public class LoadSimulationWorldFileV2Servlet extends HttpServlet {
