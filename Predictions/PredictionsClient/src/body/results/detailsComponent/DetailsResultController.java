package body.results.detailsComponent;

import static common.CommonResourcesPaths.RESULT_SIMULATION_ENTITY_DETAILS_FXML_RESOURCE;
...
public class DetailsResultController extends DetailsResultModel {
    ...
    @FXML private Label simulationIDLbl;
    @FXML private Label ticksLbl;
    @FXML private Label timeCounterLbl;
    @FXML private Label statusLbl;
    @FXML private Button stopRunningSimulationBtn;
    @FXML private Button pauseRunningSimulationBtn;
    @FXML private Button resumeRunningSimulationBtn;
    @FXML private ListView<GridPane> entitiesContainerLV;
    @FXML private HBox runningSimulationButtons;
