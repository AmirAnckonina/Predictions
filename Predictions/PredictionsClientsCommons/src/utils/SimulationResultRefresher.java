...
public class SimulationResultRefresher extends TimerTask {
    private final Consumer<SimulationDocumentInfoDto> simulationDocumentInfoDto;
    private String simulationGuid;

    public SimulationResultRefresher(Consumer<SimulationDocumentInfoDto> simulationDocumentInfoDto, String simulationGuid) {
